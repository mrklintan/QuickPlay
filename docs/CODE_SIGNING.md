...
.\scripts\Sign-QuickPlayArtifacts.ps1 -CertificateThumbprint '<thumbprint>' -Files '.\installer\QuickPlay.Installer\bin\x64\Release\QuickPlay-1.3.1.0-x64.msi'
```
...
Get-AuthenticodeSignature '.\installer\QuickPlay.Installer\bin\x64\Release\QuickPlay-1.3.1.0-x64.msi' | Format-List
```
